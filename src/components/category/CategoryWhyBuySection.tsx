...
const CategoryWhyBuySection: React.FC<CategoryWhyBuySectionProps> = ({ why_buy }) => {
  return (
    <section className="bg-gray-50 py-12 md:py-16 text-lightText">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-start mb-10 md:mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-lightText max-w-2xl">
            {why_buy.title}
          </h2>
        ...
        >
            ...
            {why_buy.products.map((product: Product, index: number) => (
              ...
              >
                <div className="flex flex-col text-left bg-white p-6 rounded-xl h-full relative shadow-sm">
                  ...
                  />
                  <h3 className="text-lg md:text-xl font-semibold text-lightText">
                    {product.title}
                  </h3>
          ...
          {why_buy.products.length > 1 && ( 
            <div className="flex justify-center items-center mt-8 md:mt-10 space-x-3">
              <CarouselPrevious 
                className="static flex items-center justify-center h-9 w-9 rounded-md bg-gray-200/80 hover:bg-gray-300/90 text-lightText disabled:opacity-50 disabled:pointer-events-none transition-colors"
              />
              <CarouselNext
                className="static flex items-center justify-center h-9 w-9 rounded-md bg-gray-200/80 hover:bg-gray-300/90 text-lightText disabled:opacity-50 disabled:pointer-events-none transition-colors"
              />
