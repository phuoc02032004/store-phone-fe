    ...
    <section className="bg-background py-12 md:py-16 text-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-start mb-10 md:mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground max-w-2xl">
            {why_buy.title}
          </h2>
        ...
        >
          <CarouselContent className="-ml-4 md:-ml-6">
            {why_buy.products.map((product: Product, index: number) => (
              ...
              >
                <div className="flex flex-col text-left bg-card p-6 rounded-xl h-full relative shadow-sm">
                  <img
                  ...
                  {product.linkHref && (
                    <div className="absolute bottom-5 right-5 md:bottom-6 md:right-6">
                      <a
                        ...
                        className="flex items-center justify-center w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground text-lg md:text-xl hover:bg-primary-foreground transition-colors"
                      >
                        +
                      </a>
                    </div>
          ...
          {why_buy.products.length > 1 && ( 
            <div className="flex justify-center items-center mt-8 md:mt-10 space-x-3">
              <CarouselPrevious
                className="static flex items-center justify-center h-9 w-9 rounded-md bg-secondary/80 hover:bg-secondary/90 text-foreground disabled:opacity-50 disabled:pointer-events-none transition-colors"
              />
              <CarouselNext
                className="static flex items-center justify-center h-9 w-9 rounded-md bg-secondary/80 hover:bg-secondary/90 text-foreground disabled:opacity-50 disabled:pointer-events-none transition-colors"
              />
