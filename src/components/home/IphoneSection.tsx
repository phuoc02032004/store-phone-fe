...
const IphoneSection: React.FC = () => {
  ...
  const sectionClasses = `relative w-full h-[700px] md:h-[750px] lg:h-[850px] flex flex-col items-center justify-between text-center p-4 overflow-hidden ${
  ...
  return (
    <section className={sectionClasses}>
      <img
        ...
        alt="iPhone 16 Pro"
        className="absolute bottom-[270px] md:bottom-[220px] left-1/2 -translate-x-1/2 w-full max-w-[700px] md:max-w-[700px]  h-auto md:object-contain object-cover"
      />
