...
const AirPodsMaxSection: React.FC = () => {
  ...
  const titleClasses = useFigmaGradient
    ? "text-5xl md:text-6xl lg:text-7xl leading-[1.0281em] tracking-[-0.9253%] font-bold mb-2 text-[#F5F5F7] "
  ...
  const buttonClasses = useFigmaGradient
    ...
    : `px-6 py-3 rounded-full text-[#6E6E73] border-[#6E6E73] hover:bg-[#6E6E73] hover:text-white font-normal text-base leading-normal tracking-tight`;
  ...
  return (
    <section className={sectionClasses}>
      ...
      />
      <div className={`relative z-10 max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto pt-10 md:pt-20 ${useFigmaGradient ? "text-white" : "text-[#6E6E73]"}`}>
        <h3 className={titleClasses}>
          AirPods Max
        </h3>
      </div>

      <div className={`relative z-10 max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto pb-10 md:pb-20 ${useFigmaGradient ? "text-white" : "text-[#6E6E73]"}`}>
