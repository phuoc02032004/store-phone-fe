...
const Navbar: React.FC = () => {
    ...
    return (        <div className="sticky top-0 z-50 flex flex-col items-center p-3 sm:p-4 md:p-6 md:flex-row md:justify-between md:items-center shadow-2xl border-[1px] border-gray-900 rounded-b-2xl sm:rounded-b-3xl backdrop-blur-3xl">
